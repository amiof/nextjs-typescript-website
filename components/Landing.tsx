...
function Landing({ }: Props) {
  return (
    <div className="bg-[url('../public/pics/landing-bg.jpg')] h-[1200px]  bg-no-repeat bg-cover bg-center relative">
      ...
      <div className='absolute top-1/3 left-60  h-60 flex flex-col  '>
        <div>
      ...
      <div className='absolute bottom-16 w-full h-[350px]   flex justify-center items-center' >
       {data.map(item=><Card DataSet={item} ></Card>)} 
      </div>
